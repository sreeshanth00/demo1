    ...
    <header class="l-header">
        <nav class="nav bd-grid">
            ...
            <div class="nav__menu" id="nav-menu">
                <ul class="nav__list">
                    <li class="nav__item"><a href="https://sky-edu.herokuapp.com" class="nav__link active">Teach</a></li>
                    <li class="nav__item"><a href="#about" class="nav__link">Profile</a></li>
                    <li class="nav__item"><a href="curd/index.php" class="nav__link">Students</a></li>
